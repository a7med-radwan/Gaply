...
<head>
            ...
            theme: {
                extend: {
                    ...
                    boxShadow: {
                        ...
                        glowBlue: '0 0 20px rgba(45, 116, 179, 0.35)',
                        glowTeal: '0 0 20px rgba(16, 185, 129, 0.25)'
                    }
                }
            }
        }
    ...
    <style>
        ...
        @keyframes fillProgress {
            ...
            to { stroke-dashoffset: 128; } /* 70% readiness */
        }
...
<body class="min-h-screen flex flex-col justify-between selection:bg-oceanBlue selection:text-white antialiased">
    ...
    <header class="border-b border-darkBorder/30 bg-darkBg/80 backdrop-blur-md sticky top-0 z-50 transition-all">
        <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <a href="/" class="flex items-center gap-3 group">
                <div class="relative w-10 h-10 rounded-xl flex items-center justify-center text-white font-black text-lg bg-gradient-to-br from-oceanBlue to-[#1e40af] shadow-premium group-hover:scale-105 transition-all duration-300">
                    G
            ...
            <nav class="hidden md:flex items-center gap-10 text-sm font-semibold text-textSecondary">
                ...
                <a href="https://github.com/a7med-radwan/Roadmap" target="_blank" class="hover:text-white transition-colors duration-200 relative group py-2">
                    Source Code
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-oceanBlue transition-all group-hover:w-full"></span>
                </a>
            </nav>
            ...
            <div class="flex items-center gap-4">
                @if (Route::has('login'))
                    @auth
                        <a href="{{ url('/dashboard') }}" class="px-5 py-2.5 rounded-xl text-sm font-bold text-white border border-darkBorder hover:border-oceanBlue hover:bg-darkCard/50 transition-all duration-300">
                            Dashboard
                        </a>
                    @else
    ...
    <section class="relative pt-24 pb-36">
        ...
        <div class="absolute top-[20%] left-1/4 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] rounded-full opacity-10 blur-[130px] pointer-events-none bg-oceanBlue animate-pulse-slow"></div>
        ...
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10">
            ...
            <div class="lg:col-span-7 text-left space-y-8">
                <div class="inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-darkBorder bg-darkCard/40 text-xs font-mono font-bold text-oceanBlue tracking-wider uppercase">
                ...
                <h1 class="font-display text-5xl md:text-7xl font-black tracking-tight text-white leading-[1.02]">
                    ...
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-oceanBlue via-[#4fa3e3] to-accentTeal">Align Your Future.</span>
                </h1>
            ...
            <div class="lg:col-span-5 relative w-full flex items-center justify-center">
                ...
                <!-- Main mockup card -->
                <div class="w-full max-w-[420px] rounded-3xl border border-darkBorder/80 bg-darkCard/90 p-6 shadow-2xl relative animate-float-slower">
                    <!-- Top header -->
                    <div class="flex items-center justify-between pb-4 border-b border-darkBorder/40 mb-6">
                        ...
                        <span class="text-[10px] font-mono font-bold uppercase tracking-wider text-textSecondary/50 bg-darkBg px-2 py-0.5 rounded">
                            Gaply Engine v2.1
                        </span>
                    </div>
                    ...
                    <!-- Target Job Spec -->
                    <div class="mb-6">
                        <p class="text-[10px] uppercase font-mono font-bold tracking-widest text-textSecondary">Target Job Profile</p>
                    ...
                    <div class="flex items-center justify-center relative my-8">
                        <svg class="w-36 h-36 transform -rotate-90">
                            ...
                            <circle cx="72" cy="72" r="62" stroke="#2d74b3" stroke-width="8" fill="transparent"
                ...
                <div class="absolute -top-6 -right-4 bg-darkBg border border-darkBorder rounded-2xl p-4 shadow-xl flex items-center gap-3 animate-float-faster z-20">
                ...
                <div class="absolute -bottom-6 -left-6 bg-darkBg border border-darkBorder rounded-2xl p-4 shadow-xl flex items-center gap-3 animate-float-faster z-20" style="animation-delay: -2.5s;">
                    <div class="w-8 h-8 rounded-lg bg-oceanBlue/10 flex items-center justify-center text-oceanBlue">
                        <span class="material-symbols-outlined text-lg">schedule</span>
                    </div>
                    <div>
                        <p class="text-[10px] text-textSecondary uppercase font-bold tracking-wider">Estimated Alignment</p>
    ...
    <section class="bg-gradient-to-r from-oceanBlue to-[#1e40af] py-16 relative overflow-hidden text-white border-y border-white/10">
        <div class="absolute inset-0 bg-grid-pattern opacity-10 pointer-events-none"></div>
        <div class="max-w-7xl mx-auto px-6 relative z-10 grid grid-cols-1 md:grid-cols-4 gap-8 divide-y md:divide-y-0 md:divide-x divide-white/20 text-center">
    ...
    <section id="features" class="py-36 bg-darkBg relative">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- feature card 1 -->
                <div class="p-8 rounded-2xl border border-darkBorder bg-darkCard/20 hover:bg-darkCard/80 hover:border-oceanBlue/50 hover:shadow-premium transition-all duration-300 group relative overflow-hidden">
                    <div class="absolute top-0 right-0 w-24 h-24 bg-oceanBlue opacity-[0.03] rounded-bl-full pointer-events-none group-hover:opacity-[0.08] transition-all"></div>
    ...
    <section id="demo" class="py-36 border-t border-darkBorder/40 bg-darkBg/40 relative">
        ...
        <div class="max-w-5xl mx-auto px-6">
            <div class="text-center max-w-2xl mx-auto mb-20 space-y-4">
                <div class="inline-block text-xs font-mono font-bold bg-darkCard border border-darkBorder text-oceanBlue px-3 py-1 rounded-full uppercase tracking-widest">
                    Try the Simulator
                </div>
            ...
            <div class="rounded-3xl border border-darkBorder/80 bg-darkCard p-6 md:p-8 shadow-2xl space-y-8">
                ...
                <div class="flex flex-wrap items-center justify-center gap-3 border-b border-darkBorder/40 pb-6">
                    <button type="button" onclick="switchDemoRole('laravel')" id="btn-laravel" class="px-5 py-2.5 rounded-xl text-xs font-mono font-bold uppercase tracking-wider transition-all border border-oceanBlue bg-oceanBlue text-white shadow-premium">
                        Laravel Architect
                    </button>
                    <button type="button" onclick="switchDemoRole('frontend')" id="btn-frontend" class="px-5 py-2.5 rounded-xl text-xs font-mono font-bold uppercase tracking-wider transition-all border border-darkBorder text-textSecondary hover:border-textSecondary/50">
                        Frontend Engineer
                    </button>
                    <button type="button" onclick="switchDemoRole('devops')" id="btn-devops" class="px-5 py-2.5 rounded-xl text-xs font-mono font-bold uppercase tracking-wider transition-all border border-darkBorder text-textSecondary hover:border-textSecondary/50">
                        DevOps Specialist
                    </button>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div class="lg:col-span-4 space-y-6">
                        <div class="p-5 rounded-2xl border border-darkBorder bg-darkBg/60">
                            <p class="text-[10px] uppercase font-mono font-bold text-textSecondary/70 tracking-widest">Computed Readiness</p>
                        ...
                        <div class="p-5 rounded-2xl border border-darkBorder bg-darkBg/60 space-y-4">
                            <div>
                                <p class="text-[10px] font-mono text-textSecondary/50 uppercase tracking-widest">Skills You Have</p>
                            ...
                            <div>
                                <p class="text-[10px] font-mono text-textSecondary/50 uppercase tracking-widest">Missing Skills (Gaps)</p>
            ...
            <div class="relative pl-8 border-l-2 border-darkBorder space-y-16 ml-4">
                ...
                <div class="relative group">
                    ...
                    <div class="p-6 rounded-2xl border border-darkBorder bg-darkCard/25 group-hover:border-oceanBlue/50 transition-all duration-300">
                        <h4 class="text-base font-bold text-white mb-2 group-hover:text-oceanBlue transition-colors">Select Target Job Role</h4>
                        <p class="text-sm text-textSecondary leading-relaxed">
                ...
                <div class="relative group">
                    ...
                    <div class="p-6 rounded-2xl border border-darkBorder bg-darkCard/25 group-hover:border-oceanBlue/50 transition-all duration-300">
                        <h4 class="text-base font-bold text-white mb-2 group-hover:text-oceanBlue transition-colors">Declare Your Skillset</h4>
                        <p class="text-sm text-textSecondary leading-relaxed">
                ...
                <div class="relative group">
                    ...
                    <div class="p-6 rounded-2xl border border-darkBorder bg-darkCard/25 group-hover:border-oceanBlue/50 transition-all duration-300">
                        <h4 class="text-base font-bold text-white mb-2 group-hover:text-oceanBlue transition-colors">Acquire Custom Learning Path</h4>
                        <p class="text-sm text-textSecondary leading-relaxed">
                ...
                <div class="relative group">
                    ...
                    <div class="p-6 rounded-2xl border border-darkBorder bg-darkCard/25 group-hover:border-oceanBlue/50 transition-all duration-300">
                        <h4 class="text-base font-bold text-white mb-2 group-hover:text-oceanBlue transition-colors">Study, Check, and Align</h4>
                        <p class="text-sm text-textSecondary leading-relaxed">
