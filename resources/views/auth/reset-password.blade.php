    ...
    <div class="max-w-[420px] w-full bg-darkCard/90 border border-darkBorder/70 rounded-3xl p-8 shadow-2xl relative z-10 space-y-8">
        ...
        <form action="{{ route('password.update') }}" method="POST" class="space-y-5">
            ...
            <div class="space-y-1.5">
                <label for="password" class="block text-[10px] font-bold uppercase tracking-wider text-textSecondary">New Password</label>
                <div class="relative">
            ...
            <div class="space-y-1.5">
                <label for="password_confirmation" class="block text-[10px] font-bold uppercase tracking-wider text-textSecondary">Confirm New Password</label>
                <div class="relative">
                    <span class="material-symbols-outlined absolute left-3.5 top-1/2 -translate-y-1/2 text-[18px] text-textSecondary">lock</span>
