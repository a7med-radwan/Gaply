    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-between p-8 md:p-12 lg:p-16 bg-darkBg relative z-10">
        ...
        <div class="my-auto max-w-[390px] w-full mx-auto py-12 space-y-8 relative z-10">
            ...
            <div class="relative flex items-center gap-3 py-1">
                <div class="flex-1 h-px bg-darkBorder/60"></div>
                <span class="text-[10px] font-mono font-bold uppercase tracking-widest text-textSecondary/40">or continue with</span>
                <div class="flex-1 h-px bg-darkBorder/60"></div>
            </div>

            {{-- Google Sign-In Button --}}
            <a href="{{ route('auth.google') }}"
               class="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-darkBorder/80 bg-darkCard/30 hover:bg-darkCard/60 hover:border-darkBorder transition-all duration-200 active:scale-[0.98] group">
                ...
                <span class="text-sm font-semibold text-textSecondary group-hover:text-white transition-colors duration-200">Sign in with Google</span>
            </a>
        </div>
